...
namespace UserControlTest
{
    ...
    {
        private PopupDismissKind _lastDismissKind;
        ...
        protected override void OnApplyTemplate()
        {
            ...
            if (_dismissButton != null)
            {
                ...
                _dismissButton.Click += DismissButton_Click;
                AutomationProperties.SetName(_dismissButton, "WCT_Popup_DismissButton_AutomationName");
            }
        ...
        public void Dismiss()
        {
            Dismiss(PopupDismissKind.Programmatic);
        }
        ...
        private void Dismiss(PopupDismissKind dismissKind)
        {
            ...
            var closingEventArgs = new PopupClosingEventArgs(dismissKind);
        ...
        {
            var eventArgs = new PopupOpeningEventArgs();
