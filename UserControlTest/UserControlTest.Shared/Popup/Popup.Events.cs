...
namespace UserControlTest
{
    ...
    public partial class Popup
    {
        ...
        /// </summary>
        public event PopupOpeningEventHandler Opening;
        ...
        /// </summary>
        public event PopupClosingEventHandler Closing;
        ...
        {
            Dismiss(PopupDismissKind.User);
        }

        private void DismissTimer_Tick(object sender, object e)
        {
            Dismiss(PopupDismissKind.Timeout);
        }
        ...
        {
            Closed?.Invoke(this, new PopupClosedEventArgs(_lastDismissKind));
