...
namespace FlexPanelTest
{
    ...
    public partial class BasisExperimentPage : Page
    {
        ...
        //static CommunityToolkit.Common.Converters StringFormatConverter = new CommunityToolkit.Common.Converters()
        static CommunityToolkit.WinUI.UI.Converters.StringFormatConverter StringFormatConverter = new CommunityToolkit.WinUI.UI.Converters.StringFormatConverter();
        //static CommunityToolkit.WinUI.UI.Converters.StringFormatConverter StringFormatConverter = new CommunityToolkit.WinUI.UI.Converters.StringFormatConverter();
