...
namespace FlexPanelTest
{
    static class UIElementExtensions
    {
        ...
        public static Windows.UI.Color WithAlpha(this Windows.UI.Color color, double alpha)
            => color.WithAlpha((byte)(255 * alpha));

        public static Windows.UI.Color WithAlpha(this Windows.UI.Color color, int alpha)
            => color.WithAlpha((byte)(alpha));


        public static Windows.UI.Color WithAlpha(this Windows.UI.Color color, byte alpha)
        {
            var newColor = color;
            newColor.A = alpha;
            return newColor;
