...
namespace P42.Uno.Controls
{
    ...
    public partial class NewBubbleBorder : Grid
    {
        ...
        void UpdatePadding()
        {
            ...
            var borderWidth = (BorderWidth > 0 && BorderColor.A > 0)
                ? BorderWidth
                : 0;
            ...
            System.Diagnostics.Debug.WriteLine($"NewBubbleBorder.UpdatePadding : padding [{padding}]");
        }
        ...
        public NewBubbleBorder()
        {
            ...
            Children.Add(new Bubble()
                .Assign(out bubble)
                .Stretch()
                .RowSpan(3)
                .ColumnSpan(3)
                .Bind(Bubble.BackgroundColorProperty, this, nameof(BackgroundColor))
                .Bind(Bubble.BorderColorProperty, this, nameof(BorderColor))
                .Bind(Bubble.BorderWidthProperty, this, nameof(BorderWidth))
                .Bind(Bubble.CornerRadiusProperty, this, nameof(CornerRadius))
                .Bind(Bubble.PointerBiasProperty, this, nameof(PointerBias))
                .Bind(Bubble.PointerLengthProperty, this, nameof(PointerLength))
                .Bind(Bubble.PointerTipRadiusProperty, this, nameof(PointerTipRadius))
                .Bind(Bubble.PointerDirectionProperty, this, nameof(PointerDirection))
                .Bind(Bubble.PointerCornerRadiusProperty, this, nameof (PointerCornerRadius))
                );

            /*
            SizeChanged += (sender, e) =>
            {
                System.Diagnostics.Debug.WriteLine($"NewBubbleBorder.SizeChanged : NewSize [{e.NewSize}]");
                System.Diagnostics.Debug.WriteLine($"NewBubbleBorder.SizeChanged : ActualSize [{ActualSize}]");
                System.Diagnostics.Debug.WriteLine($"NewBubbleBorder.SizeChanged : TextBlock.ActualSize [{Content.ActualSize}]");
                //UpdatePadding();
            };
            */
        }
