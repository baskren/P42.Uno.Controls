...
public partial class MenuFlyout : IDisposable
{
    ...
    private static void OnTargetChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (d is MenuFlyout flyout)
        {
            ...
            else if (flyout.Target is { } element)
...
internal static class MenuItemExtensions
{
    ...
    */
    ...
    {
        if (sender is MenuFlyoutItem winItem && winItem.Tag is MenuItemBase item)
            item.OnItemClicked();
    }
    ...
    public static MenuFlyoutItemBase AsMenuFlyoutItem(this MenuItemBase itemBase)
    {
        ...
        {
            var winItem = new MenuFlyoutItem
            {
                Text = itemBase.Text,
        ...
        if (itemBase is MenuGroup group)
        {

                
                
            var winGroupItem = new MenuFlyoutSubItem
            {
                Text = itemBase.Text,
                Icon = itemBase.IconSource.AsIconElement(),
            };
                
            winGroupItem.Items.Add(new MenuFlyoutItem
            {
                Text = "PIZZA 1",
            } );
            winGroupItem.Items.Add(new MenuFlyoutItem
